...
const BillBoard = () => {
    ...
    return(
        <div className='relative h-[56.25vw]'>
            <video className='w-full h-[56.25vw] object-cover brightness-[60%]' autoPlay muted loop poster={data?.thumbnailUrl} src={data?.videoUrl}>
            ...
            <div className='absolute top-[30%] md:top-[40%] ml-4 md:ml-16'>
                ...
                <p className='text-white text-[80px] md:text-lg mt-3 md:mt-8 w-[90%] md:w-[80%] lg:w-[50%] drop-shadow-xl'>
                    {data?.description}
                </p>
